...
Client.prototype.useFeatures = function() {
    if (this.state == STATE_PREAUTH) {
    	if(!this.tls_on && this.streamFeatures.getChild('starttls', NS_XMPP_TLS)) {
			var self = this;
			require('../starttls')(this.socket, {}, function() { Client.prototype.useFeatures.call(self); });
			return;
		}
    
        if(this.streamFeatures.getChild('mechanisms', NS_XMPP_SASL)) {
